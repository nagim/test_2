...
1. Receives ACR
2. Stores link:Configuration_of_MMsim/AVPs_of_MMsim.adoc[configured VPs] from the incoming ACR
3. Sends ACA with
[upperalpha]
. successful link:https://tools.ietf.org/html/rfc3588#section-7.1[Result-Code AVP]
+
or
. link:https://tools.ietf.org/html/rfc3588#section-7.6[Experimental-Result AVP]
+
or
. link:https://tools.ietf.org/html/rfc3588#section-7.1[Result-Code AVP] and a link:https://tools.ietf.org/html/rfc3588#section-7.5[Failed-AVP AVP] (rejection / not fully processed)

[options="header",cols="^verse,^.^default*10"]
|=======================================================================
|  |Basic call by a Virtual Private Network (VPN) user |Call barred on the terminating side |Call diverted due to user busy |Camel prepaid charging |Camel impacted MMTel offline charging |Camel online charging |User interaction – play announcement |User interaction -  prompt and collect |Call continued |CAMEL interaction with Location Services
|Triggered by Originating MTAS (MO) |√ |  |  |√ |√ |√ |√ |√ |√ |√
|Triggered by Terminating MTAS (MT) |  |√ |√ |  |  |  |  |  |√ | 
|Optionally triggered by forwarding MTAS (MF) |  |  |  |√ |√ |√ |  |  |√ | 
|Apply Charging (ACH) |  |  |  |√ |  |  |  |  |  | 
...
|Prompt and Collect (PC) User Information |  |  |  |  |  |  |  |√ |  | 
|Release Call (RC) |  |√ |  |  |  |  |  |  |  | 
|Request Report Basic Call State Machine (BCSM) Event (RRB) |  |  |√ |√ |  |  |  |  |  | 
|Reset Timer (RT) |√ |  |  |  |  |  |  |  |  |√
|Specialized Resource Report (SRR) |  |  |  |  |  |  |√ |√ |  | 
|Call Information Report (CIRp) |  |  |  |  |  |√ |  |  |  | 
|Apply Charging Report (ACR) |  |  |  |√ |  |  |  |  |  | 
|Event Report BCSM (ERB) – Request type |  |  |√ |  |  |  |  |  |  | 
|Event Report BCSM (ERB) – Notify type |  |  |  |√ |  |  |  |  |  | 
