...
+
The configuration file can be found at: link:http://ttcn.ericsson.se/vobs/TCC_Releases/Applications/TitanSim_LPA108463/cfg/IMS/jenkins/CallOrigWithMediaMLSimPlus_DTLS.cfg[___cfg__/IMS/jenkins/CallOrigWithMediaMLSimPlus_DTLS.cfg_].
