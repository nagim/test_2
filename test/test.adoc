...
+
The configuration file can be found at: _link:http://ttcn.ericsson.se/vobs/TCC_Releases/Applications/TitanSim_LPA108463/cfg/IMS/jenkins/CallOrigWithMediaMLSimPlus_DTLS.cfg[cfg/IMS/jenkins/CallOrigWithMediaMLSimPlus_DTLS.cfg]_.
